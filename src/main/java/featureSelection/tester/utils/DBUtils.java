...
public class DBUtils {
    ...
    public static class DatasetID {
        ...
        public final static int get(String fileName) {
            ...
            try {
                return strValue != null ? Integer.valueOf(strValue) : -1;
            } catch (Exception e) {
                return -1;
            }
        }
...
//			log.info("GET algorithm id : "+algorithmName);
    ...
    public static class ParameterID {
         ...
         * Get algorithm id in Database by name.
         *
         * @param parameters {@link ProcedureParameters} instance.
         * @return the corresponding id in Database. / -1 if no property matches.
         */
...
//			log.info("GET parameter id : "+param);
    ...
    public static class DatasetDecisionValues {
        /**
         * get dataset decision values collection
         *
         * @param dataset
         * @return java.util.Collection<java.lang.Integer>
         */
        public static Collection<Integer> get(Collection<Instance> dataset) {
            return dataset.stream().map(instance -> instance.getAttributeValue(0)).distinct().sorted().collect(Collectors.toList());
        }
    }
}