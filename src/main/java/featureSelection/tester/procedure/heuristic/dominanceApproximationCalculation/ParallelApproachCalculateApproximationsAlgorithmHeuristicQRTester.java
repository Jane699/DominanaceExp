...
import static featureSelection.repository.algorithm.alg.dominanceApproximationCalculation.ParallelApproachCalculateApproximationsAlgorithm.Basic.calculateLowerApproximationByClassUnion;
import static featureSelection.repository.algorithm.alg.dominanceApproximationCalculation.ParallelApproachCalculateApproximationsAlgorithm.Basic.calculateUpperApproximationByClassUnion;
...
@Slf4j
public class ParallelApproachCalculateApproximationsAlgorithmHeuristicQRTester extends DefaultProcedureContainer<Collection<Integer>>
        implements TimeSum,
    ...
    public ParallelApproachCalculateApproximationsAlgorithmHeuristicQRTester(ProcedureParameters parameters, boolean logOn) {
        ...
        return new ProcedureComponent<?>[]{
                ...
                new TimeCountedProcedureComponent<DominanceApproximation>(
                        ...
                        (component, parameters) -> {
                            ...
                            for (ClassUnion classUnion : classUnionSet.keySet()) {
                                ...
                                classUnionLowerApproximationMap.put(classUnion, calculateLowerApproximationByClassUnion(dataset, attributes, classUnion, classUnionSet));
                            }
                ...
                new TimeCountedProcedureComponent<DominanceApproximation>(
                        ...
                        (component, parameters) -> {
                            ...
                            Map<ClassUnion, Collection<Instance>> classUnionUpperApproximationMap = new HashMap<>(classUnionSet.size());
                            for (ClassUnion classUnion : classUnionSet.keySet()) {
                                if (logOn) {
                                    log.info("  calculate upperApproximation for " + classUnion.toString());
                                }
                                classUnionUpperApproximationMap.put(classUnion, calculateUpperApproximationByClassUnion(dataset, attributes, classUnion, classUnionSet));
                            }
                            dominanceApproximation.setUpperApproximations(classUnionUpperApproximationMap);
                            return dominanceApproximation;
                        },
                        (component, dominanceApproximation) -> {
    ...
    public String shortName() {
        return "calculate Approximations by PIAC";
    }
